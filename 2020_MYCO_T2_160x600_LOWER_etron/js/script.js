...
window.addEventListener("load", function () {
    ...
    lookupType = "new-inventory".toLowerCase().split("_").join("").split(" ").join("").split("-").join("");
...
function preloadImage(f) {
    ...
    a = [
        "2020_Audietron_Lower_F1_160x600.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2020_Audietron_Lower_F1_160x600.jpg"
    outer_backgroundTwo.src = "2020_Audietron_Lower_F2_160x600.jpg"
    if(isRetinaDisplay()){
    ...
    if("||13,279".indexOf("|") != -1){
        ...
        if("||13,279".split("|")[0] && "||13,279".split("|")[0] != ""){
            //if value is detected, adjust font size. 
            replay.style.fontSize = "||13,279".split("|")[0] + "px";
        }
        //Pipe detected, check for value after first pipe - if blank, don't adjust the color
        if("||13,279".split("|")[1] && "||13,279".split("|")[1] != ""){
            //if value is detected, adjust the color
            replay.style.color = "||13,279".split("|")[1];
        }
        //Pipe detected, check for value after the second pipe - if blank, don't adjust the coordinates
        if("||13,279".split("|")[2] && "||13,279".split("|")[2] !=""){
            //if value is detected, adjust coordinates
            //left coordinate before comma
            replay.style.left = "||13,279".split("|")[2].split(",")[0] + "px";
            //top coordinate before comma
            replay.style.top = "||13,279".split("|")[2].split(",")[1] + "px";
        }
    }


    if ("|#fff||||14,565".split("|")[1] != "") s.innerHTML += ".cta { color: " + "|#fff||||14,565".split("|")[1] + "; }\n\n";
    if ("|#fff||||14,565".split("|")[5] != "") s.innerHTML += ".cta { left: " + "|#fff||||14,565".split("|")[5].split(",")[0] + "px; top: " + "|#fff||||14,565".split("|")[5].split(",")[1] + "px; }\n";
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {y:-300, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2020_Audietron_Lower_F3_160x600.jpg";
            secondFrame = true;
...
function animateFrameThree(){
    setTimeout(function(){
        animateHeadline(function(){
            ...
            mLock.src = "etron_K_1x6.png";
            localCopy.src = "2020_Audietron_Lower_LC_160x600.png";
