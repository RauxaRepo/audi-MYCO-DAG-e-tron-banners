...
function preloadImage(f) {
    ...
    a = [
        "2020_Audietron_Lower_F1_728x90.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2020_Audietron_Lower_F1_728x90.jpg";
    outer_backgroundTwo.src = "2020_Audietron_Lower_F2_728x90.jpg";
    if(isRetinaDisplay()){
    ...
    rebuildHeadline("<span style='font-size:95%'>Plug into tomorrow.</span>|");
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {x:-364, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2020_Audietron_Lower_F3_728x90.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size:95%'>Drive it today.</span>|");
...
function animateFrameThree(){
    setTimeout(function(){
        animateHeadline(function(){
            ...
            mLock.src = "etron_K_7x9.png";
            localCopy.src = "2020_Audietron_Lower_LC_728x90.png";
...
function resizeHeadline(){
    var a = "<span style='font-size:95%'>Plug into tomorrow.</span>|";
    var b = "<span style='font-size:95%'>Drive it today.</span>|";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
...
function normalizeHeadline(f) {
    ...
    if(secondFrame){
        ...
        if ("|#fff|30,35".split("|")[2] != "") {
            inner_headline.style.left =  "|#fff|30,35".split("|")[2].split(",")[0] + "px";
            inner_headline.style.top =  "|#fff|30,35".split("|")[2].split(",")[1] + "px";
        }
        if("|#fff|30,35".split("|")[1]!= ""){
            inner_headline.style.color = "|#fff|30,35".split("|")[1];
        }
        setTimeout(function(){
            animateHeadline(function(){
              animateFrameThree();  
