...
function preloadImage(f) {
    ...
    a = [
        "2020_Audietron_Lower_F1_300x250.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2020_Audietron_Lower_F1_300x250.jpg"
    outer_backgroundTwo.src = "2020_Audietron_Lower_F2_300x250.jpg"
    if(isRetinaDisplay()){
    ...
    if("||15,105".indexOf("|") != -1){
        if("||15,105".split("|")[0] && "||15,105".split("|")[0] != ""){
            replay.style.fontSize = "||15,105".split("|")[0] + "px";
        }

        if("||15,105".split("|")[1] && "||15,105".split("|")[1] != ""){
            replay.style.color = "||15,105".split("|")[1];
        }

        if("||15,105".split("|")[2] && "||15,105".split("|")[2] !=""){
            replay.style.left = "||15,105".split("|")[2].split(",")[0] + "px";
            replay.style.top = "||15,105".split("|")[2].split(",")[1] + "px";
        }
    }
...
function animateFrameTwo(){
    ...
    TweenMax.to(inner, .63, {y:-125, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2020_Audietron_Lower_F3_300x250.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size:1em'>Drive it today.</span>|");
...
function animateFrameThree(){
    setTimeout(function(){
        animateHeadline(function(){
            ...
            mLock.src = "etron_K_3x2.png";
            localCopy.src = "2020_Audietron_Lower_LC_300x250.png";
...
function resizeHeadline(){
    ...
    var b = "<span style='font-size:1em'>Drive it today.</span>|";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
