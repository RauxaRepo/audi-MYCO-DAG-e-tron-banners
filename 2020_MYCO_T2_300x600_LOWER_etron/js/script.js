...
function preloadImage(f) {
    ...
    a = [
        "2020_Audietron_Lower_F1_300x600.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2020_Audietron_Lower_F1_300x600.jpg"
    outer_backgroundTwo.src = "2020_Audietron_Lower_F2_300x600.jpg"
    if(isRetinaDisplay()){
    ...
    if ("|#fff||||14,567".split("|")[1] != "") s.innerHTML += ".cta { color: " + "|#fff||||14,567".split("|")[1] + "; }\n\n";
    if ("|#fff||||14,567".split("|")[5] != "") s.innerHTML += ".cta { left: " + "|#fff||||14,567".split("|")[5].split(",")[0] + "px; top: " + "|#fff||||14,567".split("|")[5].split(",")[1] + "px; }\n";
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {y:-300, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2020_Audietron_Lower_F3_300x600.jpg";
            secondFrame = true;


            rebuildHeadline("<span style='font-size:..9em'>Drive it today.</span>|");
...
function resizeHeadline(){
    ...
    var b = "<span style='font-size:..9em'>Drive it today.</span>|";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
